<template>
    <div class="docs-demo-wrapper">
        <div :style="{height: isExpand ? expand : '0'}" class="demo-container">
            <div span="14">
                <div class="docs-demo docs-demo--expand" ref="expand">
...
<script>
    /* eslint-disable */
    // import Vue from 'vue'
    import {getStyle} from '../packages/utils'
    export default {
        data() {
            return {
                isExpand: false
        ...
        methods: {
            toggle() {
                ...
                this.$nextTick( ()=>{
                    setTimeout( ()=> {
                        this.$parent.$parent.fixedFooter()
                    },301)
                })
            }
        },
        computed :{
            expand () {
                return getStyle(this.$refs.expand, 'height')
            }
        }
    };
</script>
